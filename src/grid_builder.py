...
def build(words: list[str] = None, num: int = None):
    ...
    num = num if num else int(len(words) / WORD_COUNT)
            ...
            while True:
                ...
                try:
                    ...
                    try:
                        ...
                        orientations_tried.append(orientation)
...
def _get_random_orientation(exclude: set[Orientation] = None):
